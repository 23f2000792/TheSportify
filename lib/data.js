import meth from "../assets/Web/METHELESH KUMAR RATTU.jpg"
import krish from "../assets/Core/Krish-Gupta.png"
import aman from "../assets/Core/AMAN SAGAR.jpg"
import deepak from "../assets/Design/Deepak Gupta.png"
import saurabh from "../assets/Design/SAURABH.jpg"
import ritesh from "../assets/Event/RITESH KUMAR MAURYA.jpg"
import varad from "../assets/Event/VARAD RAJADHYAX.png"
import ashish from "../assets/PR/ASHISH K. CHANEJA.jpg"
import pratham from "../assets/PR/PRATHAM.jpg"





import ort from "../assets/Past-events/Orientation25.jpg"

import kt1625 from "../assets/Past-events/kota16thnov25.jpg"
import jp2425 from "../assets/Past-events/jaipur24nov25.jpg"
import delnov15 from "../assets/Past-events/delhi15nov.jpg"
...
export const pastEvents = [
  {
    ...
    "category": "Meetup",
    "description": "Join us for an exciting orientation session where we unveil the Sportify Society! Discover what makes us unique and the values we stand for. Learn about our major initiatives including thrilling sports quizzes, live watch parties of major sporting events, inspiring talk shows with renowned athletes and professionals, and exciting collaborations with other campus communities. Get a sneak peek into our ambitious 2025 events lineup featuring regional meetups, tournaments, and exclusive content. Find out how you can become a member and contribute to our growing community of passionate sports enthusiasts. Stick around for an interactive Q&A session with the Sportify core team where you can ask anything and everything about the society!",
    "image": ort,
    "isPast": true,
    "tags": ["Orientation", "Live", "Youtube"]
  },
  {
    "id": "event-19",
    "title": "Jaipur Cricket Meetup",
    "date": "24 November, 2025",
    "location": "Turbo Turf, Pink Square Mall, Jaipur",
    "category": "Meetup",
    "description": "A community cricket meetup at Turbo Turf, Pink Square Mall, Jaipur — featuring friendly matches, net practice sessions, skills drills, and networking for players of all levels. The event aimed to strengthen local cricket connections and showcase emerging talent.",
    "image": jp2425,
    "isPast": true,
    "tags": ["Cricket", "sports", "Meetup"]
  },
  {
    "id": "event-20",
    "title": "Kota Cricket Meetup",
    "date": "16 November, 2025",
    "location": " The Dugout (Electronic Complex,Kota)",
    "category": "Meetup",
    "description": "An action-packed community meetup at The Dugout (Electronic Complex, Kota) featuring coaching clinics, short-format matches, batting and bowling challenges, and opportunities for local players to connect and form teams.",
    "image": kt1625,
    "isPast": true,
    "tags": ["Cricket", "sports", "Meetup"]
  },
  {
    "id": "event-0",
    "title": "Delhi Sports Meetup",
    "date": "15 November, 2025",
    "location": "DTA Badminton Academy City Center Mall, Delhi",
    "category": "Meetup",
    "description": "The Sportify Society hosted a meetup for both cricket and Badminton Enthusiasts for friendly matches by shared love for the sport, and a fun community sports meetup.",
    "image": delnov15,
    "isPast": true,
    "tags": ["Cricket", "Badminton", "sports", "Quiz"]
  },
  {
    "id": "event-1",
...
export const teamMembers = [
  // Core
  {
    ...
    linkedin: "http://linkedin.com/in/amansagar01",
  ...
  {
    id: "member-4",
    name: "Varad Rajadhyax",
    position: "Lead",
    category: "Events & Operations",
    image: "https://ik.imagekit.io/meth/VARAD%20RAJADHYAX.png?updatedAt=1762873834123",
    linkedin: "https://www.linkedin.com/in/varadrajadhyax",
    github: "https://github.com",
    email: "22f3000445@ds.study.iitm.ac.in",
  },
  {
    id: "member-9",
    name: "Srishti Gupta",
    ...
    category: "Events & Operations",
    image: "https://ik.imagekit.io/meth/WhatsApp%20Image%202025-11-18%20at%2021.38.32_c736ae30.jpg",
  ...
  },
  {
    ...
    position: "Team Member",
    category: "Events & Operations",
    image: "https://ik.imagekit.io/meth/PRATISHTA%20MISHRA.jpg?updatedAt=1762873841282",
    linkedin: "https://linkedin.com",
    email: "",
  },
  {
    ...
    position: "Team Member",
    category: "Events & Operations",
    image: "https://ik.imagekit.io/meth/ANSHUL%20SATI.jpg?updatedAt=1762873818349",
    linkedin: "https://linkedin.com",
    email: "",
  },
  {
    ...
    position: "Team Member",
    category: "Events & Operations",
    image: "https://ik.imagekit.io/meth/PRITHIBE%20MAJUMDER.jpg?updatedAt=1762873839389",
    linkedin: "https://linkedin.com",
    email: "",
  },
  // Graphic Design
  {
    ...
    linkedin: "https://linkedin.com",
    github: "https://github.com",
    email: "24f2000262@ds.study.iitm.ac.in",
  },
  {
    id: "member-19",
    name: "Saurabh",
  ...
  // Webops
  {
    ...
    image: "https://ik.imagekit.io/meth/METHELESH%20KUMAR%20RATTU.jpg?updatedAt=1762875620300&tr=w-530%2Ch-1213%2Cfo-custom%2Ccm-extract",
    linkedin: "https://www.linkedin.com/in/mithilesh-kumar-rattu/",
    github: "https://github.com/Metheleshkumar",
  ...
  },
  {
    ...
    position: "Team Member",
    category: "Tech & Analytics",
    image: "https://ik.imagekit.io/meth/Profile_photo_just_cropped%20-%20SOVIT%20KUMAR.png?updatedAt=1762873848523",
    linkedin: "https://linkedin.com",
    github: "",
    email: "",
  },
  {
    ...
    position: "Team Member",
    category: "Tech & Analytics",
    image: "https://ik.imagekit.io/meth/%20NIKHIL%20KUMAR%20SHAH.webp?updatedAt=1762873843325",
    linkedin: "https://linkedin.com",
    email: "",
  },
  ...
  {
    id: "member-29",
    name: "Ashish K chaneja",
    position: "PR Head",
    category: "PR & Outreach",
    image: "https://ik.imagekit.io/meth/ASHISH%20K.%20CHANEJA.jpg?updatedAt=1762873821114",
    linkedin: "https://linkedin.com",
    email: "24f1000203@ds.study.iitm.ac.in",
  },
  {
    id: "member-30",
    ...
    position: "Team Member",
    category: "PR & Outreach",
    image: "https://ik.imagekit.io/meth/ATHARVA%20SHRIVASTAVA.jpg?updatedAt=1762873845005",
    linkedin: "https://linkedin.com",
    email: "",
  },
  {
    ...
    position: "Team Member",
    category: "PR & Outreach",
    image: "https://ik.imagekit.io/meth/Ayush%20Kumar%20Thakur.jpg?updatedAt=1762873844303",
    linkedin: "https://linkedin.com",
    email: "",
  },
  //Community & Engagement
  {
    ...
    image: "https://ik.imagekit.io/meth/SARTHAK%20SHARMA.png?updatedAt=1762873830100",
    linkedin: "https://linkedin.com",
    email: "",
  },
  {
    ...
    position: "Deputy Head",
    category: "Community & Engagement",
    image: "https://ik.imagekit.io/meth/Alok%20Chaudhary.jpg?updatedAt=1762873834621",
    linkedin: "https://linkedin.com",
    email: "",
  },
  {
    ...
    position: "Team Member",
    category: "Community & Engagement",
    image: "https://ik.imagekit.io/meth/AVIRAL%20TRIVEDI.JPG?updatedAt=1762873829478",
    linkedin: "https://linkedin.com",
    email: "",
  },
  {
    ...
    position: "Team Member",
    category: "Community & Engagement",
    image: "https://ik.imagekit.io/meth/SATVEER%20SINGH.jpg?updatedAt=1762873836785",
    linkedin: "https://linkedin.com",
    email: "",
  },
  {
    ...
    position: "Team Member",
    category: "Community & Engagement",
    image: "https://ik.imagekit.io/meth/KRISHNA%20GUPTA.jpg?updatedAt=1762873843096",
    linkedin: "https://linkedin.com",
    email: "",
  },
  ...
  /*{
    ...
    image: "https://ik.imagekit.io/meth/shreya.jpg?updatedAt=1762938011644",
    linkedin: "",
    email: "",
  },*/
  {
    ...
    position: "Head",
    category: "Women's Wing",
    image: "https://ik.imagekit.io/meth/JAHANVI%20SINGH.jpg?updatedAt=1762873825215",
    linkedin: "",
    email: "",
  },
  {
    ...
    position: "Team Member",
    category: "Women's Wing",
    image: "https://ik.imagekit.io/meth/LATA.jpg?updatedAt=1762873821433",
    linkedin: "",
    email: "",
  },
  {
    ...
    position: "Team Member",
    category: "Women's Wing",
    image: "https://ik.imagekit.io/meth/Varanasi%20Sai%20Sirichandana.jpg?updatedAt=1762873827602",
    linkedin: "",
    email: "",
  },
